...
*Fixes*
+ Error when ~org-sticky-header-always-show-header~ is disabled.  ([[https://github.com/alphapapa/org-sticky-header/issues/27][#27]].  Thanks to [[https://github.com/kings2u][kings2u]] for reporting.)
